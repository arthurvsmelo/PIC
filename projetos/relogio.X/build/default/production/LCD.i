...
void lcd_display_on() {
    _display_control_state |= 0x04;
    lcd_send_command(0x08 | _display_control_state);
}
...
void display_shift_right() {
    lcd_send_command(0x10 | 0x0C);
}

void display_shift_left() {
    lcd_send_command(0x10 | 0x08);
}

void cursor_shift_right() {
    lcd_send_command(0x10 | 0x04);
}
